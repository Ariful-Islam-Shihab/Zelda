...
class YSortCameraGroup(pygame.sprite.Group):
    ...
    def enemy_update(self,player):
        enemy_spirte=[sprite for sprite in self.sprites() if hasattr(sprite,'sprite_type') and sprite.sprite_type=='enemy']
        for enemy in enemy_spirte:
